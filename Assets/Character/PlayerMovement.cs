...
public class PlayerMovement : MonoBehaviour
{
    ...
    public float stepCheckDistance = 0.4f; // rayon de d�tection devant
    ...
    public float jumpGravityMultiplier = 2f; // Gravit� pendant le saut
...

        {
            ...
            if (tamere > 18f && tamere < 70 && notOnGround == false)
            {
                if (speed != 0)
                {
                    ...
                    Offsetvalue = -0.028f;
                    // 4. CLAMP VITESSE VERTICALE (�vite de voler)
            ...
            if (tamere > 20f && tamere < 70 && slopeDir.y < 0 && notOnGround == false)
            {
                ...
                // NOUVEAU : Appliquer aussi la gravit� quand en train de sauter
...
IEnumerator ResetJumpAfterLanding()
    {
        ...
        // Une fois au sol, r�initialiser le flag
        isJumping = false;
        Debug.Log("Atterrissage d�tect�");
    }
